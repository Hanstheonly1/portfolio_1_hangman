...
/*
    ...
    9. Game over
*/
const listOfWords = ["apple", "banana", "grapes", "orange", "elephant", "monkey", 
    "giraffe", "cherry", "penguin", "diamond", "octopus", "caramel", "journey", 
    "sandwich", "notebook", "fantasy", "whistle", "butter", "sunshine", "umbrella"];
let randomNumber = Math.random() * listOfWords.length;
let randomWord = listOfWords[Math.round(randomNumber)];
let correctWord = randomWord.toLowerCase();
...
while (isGameOver == false) {
    ...
    if (answer == correctWord) {
        ...
        if (isCorrect == false) {
            let checkLetter = wrongGuesses.includes(org);
